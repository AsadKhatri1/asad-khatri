    ...
    return (
        ...
        <div className='row h-50'>
            <div className='left col-lg-6 col-12  d-flex  flex-column align-items-start justify-content-center pl-3'>
              ...
              <button className='btn my-3' style={{backgroundColor:'#270580',color:'white', fontFamily:"Fira Code, monospace", } }><NavLink style={{color:'white', textDecoration:'none'}} to={props.link}>{props.btnText}</NavLink></button>
            </div>
